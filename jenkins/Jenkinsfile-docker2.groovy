                ...
                if (isPR()) {
                    ...
                    checkout changelog: false,
                        ...
                        scm: [$class: 'GitSCM',
                              ...
                              extensions: [],
                              submoduleCfg: [],
                              userRemoteConfigs: [[url: 'ssh://git@bitbucket.infinera.com:7999/bitbucket/gib/cumulus.git']]]
...
###---!!!                                       ctest -D ExperimentalMemCheck
    ...
    stage ('Report results') {
	    ...
	    sh "/files/apps/tm3000_jenkins/jenkins-bin/sh/update_br_to_db.perl -addbranch -project cumulus -branch env.BRANCH_NAME"
            if (isPR()) {
                notifySuccessful()
                merge_if_allowed()
            }
